...
class GPIO(GPIOProvider):
    ...
    def output(self, line, state):
        print("GPIO.output is deprecated; prefer set_pin_state.")
        self.set_pin_state(line, state)

    def input(self, line):
        print("GPIO.input is deprecated; prefer read_pin_state.")
        return self.read_pin_state(line)

    def setup(self, line, direction):
        print("GPIO.setup is deprecated; prefer set_up_pin.")
...
class GPIOPin(object):
    ...
    def get_direction(self):
        """ Returns the pin's direction; will be either 0 or 1 """
